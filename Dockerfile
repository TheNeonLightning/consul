...
# https://releases.hashicorp.com/consul/1.18.1/consul_1.18.1_SHA256SUMS
# https://releases.hashicorp.com/consul/1.18.1/consul_1.18.1_SHA256SUMS.sig
    wget --continue ${HASHICORP_RELEASES}/consul/${VERSION}/consul_${VERSION}_linux_${consulArch}.zip && \
    wget --continue ${HASHICORP_RELEASES}/consul/${VERSION}/consul_${VERSION}_SHA256SUMS && \
    wget --continue ${HASHICORP_RELEASES}/consul/${VERSION}/consul_${VERSION}_SHA256SUMS.sig && \
...
RUN if [ -f /tmp/build/EULA.txt ]; then mkdir -p /usr/share/doc/consul; mv /tmp/build/EULA.txt /usr/share/doc/consul/EULA.txt; fi && \
